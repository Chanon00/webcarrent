<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = $updatedata->updatecar($car_name ,$car_license ,$car_color ,$car_status ,$car_brand ,$car_price ,$car_note ,$car_id);
        if ($sql) {
            echo "<script>alert('Updated Successfully!');</script>";
            echo "<script>window.location.href='allcar.php'</script>";
        } else {
            echo "<script>alert('Something went wrong! Please try again!');</script>";
            echo "<script>window.location.href='updatecar.php?id='car_id''</script>";
        }
    }
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="car_license"
                    value="<?php echo $row['car_license']; ?>" required>
            </div>
            <div class="mb-3">
